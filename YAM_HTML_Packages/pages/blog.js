...
export default function BlogPage() {
    ...
    if (typeof window !== 'undefined') {
        ...
        document.body.classList.add('template-bloglist-rightsidebar');
    }
    ...
    return (
        <>
            <Head>
                <title>{t("Blog_ListRightSidebar_page")}</title>
            </Head>
            <Header/>
            <main>
                <Breadcrumbs />
                <div className={styles.blog_template__layout}>
                    <div className="container">
                        <div className='row'>
                            <div className={`${styles.blog_template__content} ${styles.blog_template__content_padding_right} is-sidebar col-12 col-sm-9`}>
                            ...
                            <div className={`${styles.blog_template__sidebar__right} col-12 col-sm-3 d-none d-md-block`}>
                                <div className="blog-sidebar__content">
                                    <div className={`${styles.blog_sidebar__item} accordion blog-sidebar__listing is-active ${sidebarCategory ? 'open' : ''}`}>
                                        <h4 className={`accordion__title ${styles.blog_sidebar__item_accordion__title}`} onClick={() => setSidebarCategory(o => !o)}>
                                            <span>{BlogData.category_title}</span>
