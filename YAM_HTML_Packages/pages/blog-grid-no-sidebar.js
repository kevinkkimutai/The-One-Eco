...
export default function BlogPage() {
    ...
    return (
        <>
            <Head>
                <title>{t("Blog_GridNoSidebar_page")}</title>
            </Head>
            <Header/>
            <main>
                <Breadcrumbs />
                    ...
                    <div className="container">
                        <div className='row'>                        
                            <div className={`${styles.blog_template__content} col-12 col-sm-12`}>                                
                                <div className={`blog-template__articles row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-3`}>
